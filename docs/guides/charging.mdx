...
- Der Ladevorgang wird immer unterbrochen, wenn über eine definierte Dauer ([Standard: 3 Minuten](/docs/reference/configuration/loadpoints#disable)) nicht genügend Strom für eine [Mindestleistung](#ich-habe-pv-überschuss-aber-das-auto-lädt-nicht-warum) vorhanden ist.
