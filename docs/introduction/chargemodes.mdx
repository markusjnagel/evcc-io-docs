...
Sollte die Ladung im Modus PV unterbrochen werden, obwohl _eigentlich_ die Sonne scheint, einfach kurz auf den Hausverbrauch schauen, denn Überschuss bedeutet: PV Leistung - Hausverbrauch = zur Verfügung stehende Leistung, die sonst ins Netz eingespeist werden würde.  
...
Also stelle ich das batterieunterstützte Laden herunter (z.B. auf 50%, wenn ich 50% Batterie für die Nacht brauche), lasse die Hausbatterie erstmal Leistung von der PV "aufsammeln", um sie dann automatisch, unterstützt durch die Batterie mit 4.2 kW (3P) ins Auto zu schicken.  
Ohne Hilfe der Batterie würden die 4.2 kW nicht erreicht werden können.  
Das hält dann wieder an, sobald 3.) unterschritten wird, sie sammelt wieder auf, usw. usf. 
